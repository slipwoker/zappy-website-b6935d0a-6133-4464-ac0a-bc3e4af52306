document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (minLength && value.length < parseInt(minLength, 10)) {
          errorMessage = field.getAttribute('data-error-minlength') ||
            'Please enter at least ' + minLength + ' characters.';
        }

        const maxLength = field.getAttribute('maxlength');
        if (maxLength && value.length > parseInt(maxLength, 10)) {
          errorMessage = field.getAttribute('data-error-maxlength') ||
  ...
  function handleFormSuccess(form) {
    ...
    if (submitBtn) {
      ...
      submitBtn.textContent = submitBtn.getAttribute('data-sent-text') || 'Sent!';
  ...
  const dynamicObserver = new MutationObserver(function (mutations) {
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        children.forEach(initElementAnimation);
      });
    });
  });
  ...
  function initElementAnimation(el) {
    ...
    if ('IntersectionObserver' in window) {
      const singleObserver = new IntersectionObserver(function (entries, obs) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'b6935d0a-6133-4464-ac0a-bc3e4af52306',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'b6935d0a-6133-4464-ac0a-bc3e4af52306';
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 972544489858 placeholder which businessInfoUpdater can replace
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b6935d0a-6133-4464-ac0a-bc3e4af52306';
